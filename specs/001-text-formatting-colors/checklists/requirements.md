...
- FR-015 mentions "98.css conventions" — this is a project-level design constraint documented in the constitution, not an implementation detail. It describes the aesthetic requirement.
