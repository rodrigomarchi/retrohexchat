...
- [x] T049 [US5] Style notification center panel in `apps/retro_hex_chat_web/assets/css/notification-center.css` — 98.css window styling, positioned absolute below bell icon, max-height with scroll, entry hover state, badge count styling on bell icon, z-index above other panels
