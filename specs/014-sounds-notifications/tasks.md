...
- [X] T025 [US2] Add CSS for mute button in `apps/retro_hex_chat_web/assets/css/layout.css` — style the mute toggle button within the status bar to look like a Windows 98 status bar indicator (small, clickable, togglable appearance).
