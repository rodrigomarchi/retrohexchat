...
|---|---|---|---|---|---|---|---|---|
| `group_call/group_call_webrtc_hook.js` | 2414→2106 | sim | sim | sim | W4·W5·W-E | **decisões + track/participant registries** | p2p/negotiation, group_call/{quality,payload,reactions,layout,tiles,media_state,track_registry,participant_registry} | resíduo: pc ao vivo (irredutível) + DOM de tiles (bind dos registros aos elementos) |
| `lobby/lobby_webrtc_hook.js` | 1136→1164 | sim | sim | sim | W4·W-D | **W-D feito** | p2p/negotiation, p2p/signaling_session | resíduo: 1 pc ao vivo + timers + ICE/track + pushEvent (I/O); cresceu por prettier multi-arg |
