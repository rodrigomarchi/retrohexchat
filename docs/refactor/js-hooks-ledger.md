...
| `lobby/lobby_webrtc_hook.js` | 1164→**13** | sim | sim | sim | W4·W-D·W-H | **W-H: hook virou casca** | p2p/negotiation, p2p/signaling_session, **p2p/lobby_connection** (controlador de 1164 linhas, dono do pc) | teste ainda alcança privados via o hook (part B: mover teste p/ test/lib black-box) |
