...
| AI9 | Video layout | New | Remote video: large, fills main area. Local video: small PiP overlay in corner (draggable). Audio-only layout: large area shows peer name + audio waveform indicator + duration timer. retro-styled window chrome |
