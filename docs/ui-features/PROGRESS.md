...
| 12 | Server Administration | P3 | 🟦 | — | 2026-06-05 | MOTD menu, Admin Console shell, Server Settings/MOTD/Broadcast/Audit Log/TURN/Danger Zone tabs complete; Users snapshot/Info/moderation and Channels snapshot/Info/Create complete; rename/role/NickServ and destructive channel/ChanServ actions remain |
