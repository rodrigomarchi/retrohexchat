<!--
  ...
  Added sections:
    - Principle XI: User-Facing Documentation
  ...
  Templates requiring updates:
    ...
    - .specify/templates/spec-template.md: ✅ No update needed
      (Generic template; documentation requirement enforced at plan/task level)
    - .specify/templates/tasks-template.md: ✅ No update needed
      (Generic template; help topic tasks generated by /speckit.tasks from spec)
    - .specify/templates/checklist-template.md: ✅ No update needed
      (Generic template; /speckit.checklist generates items from constitution)

  Runtime guidance updates:
    - CLAUDE.md: ✅ Already updated (Help System mandatory section added)
    - MEMORY.md: ✅ Already updated (critical rule about mandatory help docs)
