...
PO_OVERRIDES = {
    ...
    "Call: %{channel} (%{count})": t(
        ...
        ar="مكالمة: %{channel} (%{count})",
        ru="Звонок: %{channel} (%{count})",
        hi="कॉल: %{channel} (%{count})",
        ko="통화: %{channel} (%{count})",
        tr="Arama: %{channel} (%{count})",
        vi="Cuộc gọi: %{channel} (%{count})",
        bn="কল: %{channel} (%{count})",
        ur="کال: %{channel} (%{count})",
    ...
    "Call: error in %{channel}": t(
        ...
        ar="خطأ في المكالمة في %{channel}",
        ru="Ошибка звонка в %{channel}",
        hi="%{channel} में कॉल त्रुटि",
        ko="%{channel} 통화 오류",
        tr="%{channel} içinde arama hatası",
        vi="Lỗi cuộc gọi trong %{channel}",
        bn="%{channel}-এ কল ত্রুটি",
        ur="%{channel} میں کال کی خرابی",
    ...
    "P2P Session with %{peer}": t(
        ...
        ar="جلسة P2P مع %{peer}",
        ru="P2P-сеанс с %{peer}",
        hi="%{peer} के साथ P2P सत्र",
        ko="%{peer}님과의 P2P 세션",
        tr="%{peer} ile P2P oturumu",
        vi="Phiên P2P với %{peer}",
        bn="%{peer}-এর সাথে P2P সেশন",
        ur="%{peer} کے ساتھ P2P سیشن",
    ...
    "P2P session with %{peer} - %{facets}": t(
        ...
        ar="جلسة P2P مع %{peer} - %{facets}",
        ru="P2P-сеанс с %{peer} - %{facets}",
        hi="%{peer} के साथ P2P सत्र - %{facets}",
        ko="%{peer}님과의 P2P 세션 - %{facets}",
        tr="%{peer} ile P2P oturumu - %{facets}",
        vi="Phiên P2P với %{peer} - %{facets}",
        bn="%{peer}-এর সাথে P2P সেশন - %{facets}",
        ur="%{peer} کے ساتھ P2P سیشن - %{facets}",
    ...
    "%{peer} wants to play": t(
        ...
        hi="%{peer} खेलना चाहता है",
        ko="%{peer}님이 플레이하려고 합니다",
        tr="%{peer} oynamak istiyor",
        vi="%{peer} muốn chơi",
        bn="%{peer} খেলতে চায়",
        ur="%{peer} کھیلنا چاہتا ہے",
        zh_hant="%{peer} 想玩",
    ),
    "Retrying the peer connection, attempt %{attempt} of 3.": t(
        ...
        ar="إعادة محاولة اتصال النظير، المحاولة %{attempt} من 3.",
        ru="Повторное подключение к пиру, попытка %{attempt} из 3.",
        hi="पीयर कनेक्शन फिर से आज़माया जा रहा है, 3 में से %{attempt} प्रयास।",
        ko="피어 연결 재시도 중, 3회 중 %{attempt}번째 시도입니다.",
        tr="Eş bağlantısı yeniden deneniyor, 3 denemeden %{attempt}.",
        vi="Đang thử lại kết nối ngang hàng, lần thử %{attempt}/3.",
        bn="পিয়ার সংযোগ পুনরায় চেষ্টা হচ্ছে, 3টির মধ্যে %{attempt}তম চেষ্টা।",
        ur="پیئر کنکشن دوبارہ آزمایا جا رہا ہے، 3 میں سے %{attempt} کوشش۔",
    ...
    "Call and game stay active with %{peer}.": t(
        ...
        ar="تبقى المكالمة واللعبة نشطتين مع %{peer}.",
        ru="Звонок и игра остаются активными с %{peer}.",
        hi="कॉल और गेम %{peer} के साथ सक्रिय रहते हैं।",
        ko="통화와 게임은 %{peer}님과 계속 활성 상태입니다.",
        tr="Arama ve oyun %{peer} ile etkin kalır.",
        vi="Cuộc gọi và trò chơi vẫn hoạt động với %{peer}.",
        bn="কল এবং গেম %{peer}-এর সাথে সক্রিয় থাকে।",
        ur="کال اور گیم %{peer} کے ساتھ فعال رہتے ہیں۔",
