...
defmodule I18nDomainizeGettextCalls do
  ...
  defp web_domain(rest) do
    cond do
      ...
      String.contains?(rest, "/controllers/v2/session_controller") -> "connect"
      ...
      String.contains?(rest, "/components/layouts/v2") -> "ui"
      ...
      String.contains?(rest, "/live/v2/connect_live") -> "connect"
      String.contains?(rest, "/live/v2/chat_live") -> "chat"
      String.contains?(rest, "/live/v2/p2p_session") -> "p2p"
      String.contains?(rest, "/live/v2/p2_p_session") -> "p2p"
      String.contains?(rest, "/live/v2/game_session") -> "games"
      String.contains?(rest, "/live/v2/solo_session") -> "games"
      String.contains?(rest, "/live/v2/arcade_game") -> "arcade"
      String.contains?(rest, "/live/v2/v2_helpers") -> "chat"
      String.contains?(rest, "/live/v2/session_helpers") -> "chat"
