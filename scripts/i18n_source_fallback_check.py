...
TECHNICAL_SOURCE_ALLOWLIST = [
    ...
    r"^Participant %\{id\}$",
    r"^P2P: %\{peer\}(?: %\{duration\})?$",
    r"^%\{active\}/%\{total\} active$",
    r"^%\{audio\} audio / %\{video\} video / %\{screen\} screen$",
    r"^%\{connected\}/%\{total\} connected$",
    r"^%\{connection\} / ICE %\{ice\}$",
    r"^%\{count\} tracks$",
    r"^%\{health\} / %\{latency\} ms$",
    r"^%\{inbound\} in / %\{fanout\} fanout$",
    r"^%\{jitter\} ms jitter / %\{loss\}% loss$",
    r"^%\{layout\} / %\{self\}$",
    r"^%\{latency\} ms / %\{loss\}% loss$",
    r"^%\{n\} (?:fps|kbps|ms|subs)$",
    r"^%\{nominated\}/%\{total\} nominated(?: / %\{valid\} valid)?$",
    r"^%\{packets\} pkt / %\{bytes\}$",
    r"^%\{participants\} / %\{tracks\} tracks$",
    r"^%\{sent\} up / %\{received\} down$",
    r"^%\{source\} / %\{resolution\} / %\{fps\} fps$",
    r"^%\{state\} / %\{down\} down / %\{up\} up$",
    r"^%\{state\} / %\{resolution\}$",
    r"^%\{state\} / %\{reason\}$",
    r"^%\{state\} / %\{sent\} sent / %\{received\} received$",
    r"^%\{state\} / %\{source\}$",
    r"^%\{status\} / max %\{max\}$",
    r"^%\{subs\} subs / %\{routes\} routes$",
    r"^%\{tracks\} trk / %\{packets\} pkt / %\{bytes\}$",
