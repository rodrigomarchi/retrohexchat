 ...
 * @flow P3 [done] Incoming PM marks indicator without switching active tab (features P0)
 * @flow P4 [done] Incoming channel message marks unread without switching active tab (features P0)
 *
