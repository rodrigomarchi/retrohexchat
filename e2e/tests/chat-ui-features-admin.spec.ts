  ...
  test("Admin Console structured tabs and MOTD menu exercise safe admin UI paths (Feature 12)", async ({
    ...
    try {
      ...
      await admin.page
        ...
        .click();
      await expect(inlineResult("server_settings")).toContainText(
        newDescription,
      );
      ...
      await admin.page
        .locator("#admin-console-channel-create-name")
        .fill(channel);
      await admin.page
      ...
      await admin.page
        .locator("#admin-console-channel-info-name")
        .fill(channel);
      await admin.page
      ...
      await admin.page
        ...
        .click();
      await expect(
        admin.page.getByTestId("admin-console-motd-result"),
      ).toContainText("MOTD has been updated.");
      await expect(
        admin.page.locator("#admin-console-motd-current"),
      ).toContainText(motd);
      ...
      await admin.page
        ...
        .click();
      await expect(inlineResult("broadcast")).toContainText(
      ...
      await expect(
        admin.page.locator("#admin-console-turn-stats"),
      ).toContainText("TURN");
      await admin.page
        ...
        .click();
      await expect(
        admin.page.locator("#admin-console-turn-allocations"),
      ...
      await admin.page
        .locator("#admin-console-audit-log-user")
        .fill(ADMIN_NICK);
      await admin.page
        ...
        .click();
      await expect(
        admin.page.locator("#admin-console-audit-log-output"),
      ).toContainText(ADMIN_NICK);

      await admin.chat.switchAdminConsoleToTab("danger_zone");
      await expect(
        admin.page.locator("#admin-console-danger-preview"),
      ...
      await admin.chat.adminConsoleDialog
