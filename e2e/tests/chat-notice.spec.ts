 ...
 * @flow J2 [done] `/notice bob text` delivers notice without opening PM tab (features P0)
 * @flow J3 [done] `/notice #room text` delivers to channel and respects routing (features P1)
 * @flow J4 [done] `/notice_routing` reports current routing behavior (features P2)
 *
