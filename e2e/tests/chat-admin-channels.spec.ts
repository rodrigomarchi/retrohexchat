 ...
 * @flow M9 [done] `/admin channel create/info/list/banlist/delete` over unique channels (features P1)
 * @flow M10 [done] `/admin channel purge #room --from bob` removes bob's visible history only (features P2)
 *
