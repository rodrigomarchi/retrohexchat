 ...
 * @flow O6 [done] Search opens, highlights, navigates, invalid regex errors (features P1)
 * @flow O7 [done] Search options persist while search stays open (features P2)
 *
