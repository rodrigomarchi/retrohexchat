...
export const lazyFeatureHooks = {
  ...
  LobbyWebRTCHook: lazyFeatureHook({
    ...
    reason: "Universal lobby WebRTC signaling is a heavy session feature.",
  }),
  LobbyMediaHook: lazyFeatureHook({
    ...
    reason: "Universal lobby media capture is only needed inside an active lobby.",
  }),
  LobbyGameCanvasHook: lazyFeatureHook({
    ...
    reason: "Universal lobby game canvas and engine loading are heavy features.",
  }),
