...
import {
  ...
  encodeGameEnd,
  encodeGameReady,
} from "../../../js/lib/games/breakout_protocol.js";
import { createInitialState, CANVAS_W, CANVAS_H } from "../../../js/lib/games/breakout_physics.js";

// Must mock breakout_audio before importing BreakoutEngine
vi.mock("../../../js/lib/games/breakout_audio.js", () => ({
...
vi.mock("../../../js/lib/games/breakout_renderer.js", () => ({
  getColors: vi.fn(() => ({
    bg: "#0a0a1a",
    fg: "#00ffcc",
    accent: "#ff0066",
...
const { BreakoutEngine } = await import("../../../js/lib/games/breakout_engine.js");
const { render, getColors } = await import("../../../js/lib/games/breakout_renderer.js");
