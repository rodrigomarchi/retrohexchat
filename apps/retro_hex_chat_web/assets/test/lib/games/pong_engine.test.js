...
import { createInitialState, CANVAS_W, CANVAS_H } from "../../../js/lib/games/pong_physics.js";

// Must mock pong_audio before importing PongEngine
vi.mock("../../../js/lib/games/pong_audio.js", () => ({
  PongAudio: function () {
    return {
      playPaddleHit: vi.fn(),
...
vi.mock("../../../js/lib/games/pong_renderer.js", () => ({
  getColors: vi.fn(() => ({
    bg: "#0a0a1a",
    fg: "#00ffcc",
    accent: "#ff0066",
...
const { PongEngine } = await import("../../../js/lib/games/pong_engine.js");
const { render, getColors } = await import("../../../js/lib/games/pong_renderer.js");
