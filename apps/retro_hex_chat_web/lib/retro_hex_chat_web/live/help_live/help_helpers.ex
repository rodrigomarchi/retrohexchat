defmodule RetroHexChatWeb.HelpLive.HelpHelpers do
  ...
  @doc """
  Full-page help desktop: the shared Win98 window manager (menu bar + status bar +
  taskbar) hosting a single pinned "Help" window laid out like the classic Windows
  Help (CHM) viewer — a toolbar, a tabbed navigator (Contents / Index / Search) and
  the content pane.
  """
  ...
  # ── Toolbar (CHM-style: Back / Forward / Home + search) ─────
  ...
  # ── Navigator (tabbed: Contents / Index / Search) ───────────
  ...
  @doc "Render a topic's related links from its `see_also` topic ids."
  ...
  @spec toolbar_btn_class() :: String.t()
  defp toolbar_btn_class,
    do:
