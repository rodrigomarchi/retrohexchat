  ...
  def render(assigns) do
    ...
    <.landing_layout active_page={@active_page}>
      <section class="m-4" aria-labelledby="faq-heading">
        <.window>
          <.window_title_bar title="Frequently Asked Questions" controls={[:close]}>
          ...
          <.window_status_bar>
            <.window_status_bar_field grow>12 questions</.window_status_bar_field>
          </.window_status_bar>
        </.window>
      </section>
    </.landing_layout>
