defmodule RetroHexChatWeb.ShowcaseLive.PasteConfirmDialogPage do
  @moduledoc false
  ...
  def mount(_params, _session, socket) do
    {:ok, assign(socket, page_title: "Paste Confirm Dialog", active_page: "paste-confirm-dialog")}
  end
  ...
  def render(assigns) do
    ...
    <.showcase_layout active_page={@active_page}>
      <h2 class="text-lg font-bold mb-3">Paste Confirm Dialog</h2>

      <.showcase_card
        title="Standard Paste Confirmation"
