defmodule RetroHexChatWeb.ShowcaseLive.Tabs do
  @moduledoc false
    ...
    <.showcase_layout active_page={@active_page}>
      ...
      >
        <.tabs :let={builder} id="showcase-tabs" default="tab1">
          <.tabs_list>
            <.tabs_trigger builder={builder} value="tab1">Account</.tabs_trigger>
            <.tabs_trigger builder={builder} value="tab2">Password</.tabs_trigger>
