defmodule RetroHexChatWeb.ShowcaseLive.Switch do
  @moduledoc false
  ...
  def mount(_params, _session, socket) do
    {:ok, assign(socket, page_title: "Switch", active_page: "switch")}
  end
  ...
  def render(assigns) do
    ...
    <.showcase_layout active_page={@active_page}>
      <h2 class="text-lg font-bold mb-3">Switch</h2>
      ...
      >
        <div class="space-y-3">
          <div class="flex items-center gap-2">
            <.switch id="switch-1" />
            <.label for="switch-1">Airplane mode</.label>
          </div>
          <div class="flex items-center gap-2">
