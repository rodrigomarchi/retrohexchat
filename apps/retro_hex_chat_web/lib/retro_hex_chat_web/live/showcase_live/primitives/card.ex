defmodule RetroHexChatWeb.ShowcaseLive.Primitives.Card do
  ...
  def render(assigns) do
    ...
    <.showcase_layout active_page={@active_page}>
      <h2 class="text-lg font-bold mb-3">{dgettext("showcase", "Card")}</h2>
        ...
        <div class="max-w-sm">
          <.card>
            <.card_header>
              ...
              <.card_title>{dgettext("showcase", "Card Title")}</.card_title>
              <.card_description>
                {dgettext("showcase", "Card description goes here.")}
              </.card_description>
            </.card_header>
            <.card_content>
              <p>
                {dgettext("showcase", "This is the card content area. You can put any content here.")}
              </p>
            </.card_content>
            <.card_footer>
