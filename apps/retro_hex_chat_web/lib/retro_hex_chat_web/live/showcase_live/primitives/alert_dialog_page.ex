defmodule RetroHexChatWeb.ShowcaseLive.Primitives.AlertDialogPage do
  ...
  def mount(_params, _session, socket) do
    {:ok,
     assign(socket, page_title: dgettext("showcase", "Alert Dialog"), active_page: "alert-dialog")}
  end
  ...
  def render(assigns) do
    ...
    <.showcase_layout active_page={@active_page}>
      <h2 class="text-lg font-bold mb-3">{dgettext("showcase", "Alert Dialog")}</h2>
        ...
        <.alert_dialog :let={builder} id="alert-default">
          <.alert_dialog_trigger builder={builder}>
            <.button variant="outline">
              ...
              {dgettext("showcase", "Show Alert Dialog")}
            </.button>
          ...
          <.alert_dialog_content builder={builder}>
            <.alert_dialog_header>
              <:icon><Icons.icon_warning class="w-4 h-4" /></:icon>
              <.alert_dialog_title>
                {dgettext("showcase", "Are you absolutely sure?")}
              </.alert_dialog_title>
            ...
            <.alert_dialog_footer>
              <.alert_dialog_cancel builder={builder}>
                {dgettext("showcase", "Cancel")}
              </.alert_dialog_cancel>
              <.alert_dialog_action>{dgettext("showcase", "Continue")}</.alert_dialog_action>
            </.alert_dialog_footer>
      ...
      <.showcase_card
        title={dgettext("showcase", "Destructive")}
        ...
        <.alert_dialog :let={builder} id="alert-destructive">
          ...
          <.alert_dialog_content builder={builder}>
            <.alert_dialog_header>
              ...
              <.alert_dialog_title>{dgettext("showcase", "Delete Account")}</.alert_dialog_title>
              <.alert_dialog_description>
                {dgettext(
                  "showcase",
