defmodule RetroHexChatWeb.ShowcaseLive.NicklistPage do
  @moduledoc false
  ...
  def render(assigns) do
    ...
    <.showcase_layout active_page={@active_page}>
      ...
      <.showcase_card title="Basic Nicklist" description="User list with status indicators.">
        <div class="max-w-[180px]">
          <.nicklist class="min-h-[120px]">
            <.nicklist_item nick="Troll" status="online" role="op" nick_color="text-success-dark" />
      ...
      <.showcase_card title="Roles" description="Users with operator (@) and voice (+) prefixes.">
        <div class="max-w-[180px]">
          <.nicklist>
            <.nicklist_item nick="Admin" status="online" role="op" nick_color="text-error" />
            <.nicklist_item nick="Moderator" status="online" role="voice" nick_color="text-warning" />
            <.nicklist_item nick="Regular" status="online" />
            <.nicklist_item nick="Lurker" status="away" />
          </.nicklist>
        </div>
        <.code_example>
          &lt;.nicklist_item nick="Admin" role="op" nick_color="text-error" /&gt;
          &lt;.nicklist_item nick="Moderator" role="voice" nick_color="text-warning" /&gt;
