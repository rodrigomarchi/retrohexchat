defmodule RetroHexChatWeb.ShowcaseLive.KickDialogPage do
  @moduledoc false
  ...
  def mount(_params, _session, socket) do
    {:ok, assign(socket, page_title: "Kick Dialog", active_page: "kick-dialog")}
  end
  ...
  def render(assigns) do
    ...
    <.showcase_layout active_page={@active_page}>
      <h2 class="text-lg font-bold mb-3">Kick Dialog</h2>

      <.showcase_card
        title="With Kick Info"
