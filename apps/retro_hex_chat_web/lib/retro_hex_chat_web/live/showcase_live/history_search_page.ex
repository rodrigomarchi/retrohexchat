defmodule RetroHexChatWeb.ShowcaseLive.HistorySearchPage do
  @moduledoc false
  ...
  def mount(_params, _session, socket) do
    {:ok, assign(socket, page_title: "History Search", active_page: "history-search")}
  end
  ...
  def render(assigns) do
    ...
    <.showcase_layout active_page={@active_page}>
      <h2 class="text-lg font-bold mb-3">History Search</h2>
      ...
      >
        <div class="shadow-retro-field bg-white p-3 min-h-[40px] flex items-center justify-center">
          <span class="text-xs text-muted-foreground">(empty — history_search renders nothing)</span>
        </div>
