defmodule RetroHexChatWeb.ShowcaseLive.Accordion do
  @moduledoc false
  ...
  def mount(_params, _session, socket) do
    {:ok, assign(socket, page_title: "Accordion", active_page: "accordion")}
  end
  ...
  def render(assigns) do
    ...
    <.showcase_layout active_page={@active_page}>
      <h2 class="text-lg font-bold mb-3">Accordion</h2>

      <.showcase_card title="Usage" description="Vertically collapsing content panels.">
        <div class="max-w-sm">
          <.accordion>
            <.accordion_item>
