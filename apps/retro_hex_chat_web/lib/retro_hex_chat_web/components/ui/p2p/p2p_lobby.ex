defmodule RetroHexChatWeb.Components.UI.P2PLobby do
  ...
  attr :stats, :map, default: nil, doc: "Live WebRTC connection stats for the network panel"
  attr :network_collapsed, :boolean, default: false, doc: "Whether the network panel is collapsed"

  attr :network_info_open, :boolean,
    default: false,
    doc: "Whether per-metric descriptions are shown in the network panel"
  ...
  @spec p2p_network_panel(map()) :: Phoenix.LiveView.Rendered.t()
  defp p2p_network_panel(assigns) do
    ~H"""
    <.retro_fieldset
      legend={dgettext("p2p", "Network")}
      class="p2p-lobby__net"
      data-testid="p2p-network-panel"
    >
      <div class="flex items-center gap-2 mb-1">
        ...
        >
          ...
          <span class="text-xs font-bold" data-testid="p2p-network-health">
            {net_health_label(@stats[:level])}
          </span>
        </span>
        <span
          class="text-xs text-muted-foreground"
          data-testid="p2p-network-mos"
        ...
        <.toolbar variant="compact" class="gap-[1px] ml-auto">
          ...
          <.toolbar_button
            ...
            data-testid="p2p-network-toggle"
          >
      ...
      <p
        :if={!@collapsed && @info_open}
        class="text-[10px] text-muted-foreground leading-tight mb-1"
        data-testid="p2p-network-mos-desc"
      >
        {net_metric_tip(:mos)}
      </p>
  ...
  @spec p2p_net_row(map()) :: Phoenix.LiveView.Rendered.t()
  defp p2p_net_row(assigns) do
    ~H"""
