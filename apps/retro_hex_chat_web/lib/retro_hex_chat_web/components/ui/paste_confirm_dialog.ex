  ...
  def paste_confirm_dialog(assigns) do
    ...
    <span data-testid="paste-confirm-dialog">
      <.dialog id={@id} show={@show}>
        <.dialog_header>
          <.dialog_icon>
            <Icons.icon_dialog_paste class="w-4 h-4" />
          </.dialog_icon>
          <.dialog_title>Paste Confirmation</.dialog_title>
          <.dialog_close id={@id} />
        </.dialog_header>
        ...
        <.dialog_body>
          <div class="space-y-retro-8">
            <p class="text-xs">
              You are about to send <span class="font-bold">{@line_count}</span>
              {if @line_count == 1, do: "line", else: "lines"} of text.
            </p>
            ...
            <p class="text-xs text-muted-foreground">
              Are you sure you want to send all lines at once?
            </p>
          </div>
        </.dialog_body>
