defmodule RetroHexChatWeb.Components.UI.ChatContextMenu do
  ...
  defp nick_menu_items(assigns) do
    ~H"""
    <.context_menu_item on_click={@on_action} action="pm" phx-value-nick={@target_nick}>
    ...
    <.context_menu_item on_click={@on_action} action="copy_nick" phx-value-nick={@target_nick}>
    ...
    <.context_menu_item on_click={@on_action} action="address_book" phx-value-nick={@target_nick}>
  ...
  defp url_menu_items(assigns) do
    ~H"""
    <.context_menu_item on_click={@on_action} action="open_link" phx-value-url={@target_url}>
      <:icon><Icons.icon_link class="w-[14px] h-[14px]" /></:icon>
      Open Link
    </.context_menu_item>
    <.context_menu_item on_click={@on_action} action="copy_url" phx-value-url={@target_url}>
      <:icon><Icons.icon_copy class="w-[14px] h-[14px]" /></:icon>
      Copy URL
    </.context_menu_item>
    <.context_menu_item on_click={@on_action} action="save_url" phx-value-url={@target_url}>
  ...
  defp message_menu_items(assigns) do
    ...
    ~H"""
    <.context_menu_item on_click={@on_action} action="copy_message" phx-value-text={@msg_text}>
      <:icon><Icons.icon_copy class="w-[14px] h-[14px]" /></:icon>
      Copy Message
    </.context_menu_item>
    <.context_menu_item on_click={@on_action} action="reply" phx-value-message_id={@msg_id}>
