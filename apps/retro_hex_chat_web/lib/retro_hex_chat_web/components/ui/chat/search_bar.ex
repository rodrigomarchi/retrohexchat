defmodule RetroHexChatWeb.Components.UI.SearchBar do
  ...
  def search_bar(assigns) do
    ...
    <.window
      ...
      {@rest}
    >
      <.window_title_bar title={dgettext("chat", "Find")} controls={[:close]} on_close={@on_close}>
      ...
      <.window_body class="p-retro-8 space-y-retro-8">
        ...
        <form class="flex items-center gap-retro-4" phx-change={@on_search} phx-submit={@on_search}>
          <.input
            ...
            id="search-bar-input"
            value={@query}
            placeholder={dgettext("chat", "Find text...")}
            class="flex-1"
            name="query"
            phx-debounce="300"
