  ...
  def account_panel(assigns) do
    ...
    <div id={@id} class="contents">
      <.focus_wrap id={"#{@id}-focus-wrap"} class="contents">
        ...
        >
          <.tabs :let={builder} id={"#{@id}-tabs"} default={@active_tab} class="acct-tabs min-h-0">
            <div class="acct-tabs-shell">
              <.tabs_list class="acct-main-tabs px-0 pt-0">
            ...
            <.tabs_content builder={builder} value="register" class="acct-tab-content">
              <.register_tab
                nickname={@nickname}
            ...
            <.tabs_content builder={builder} value="profile" class="acct-tab-content">
              <.profile_tab
                nickname={@nickname}
            ...
            <.tabs_content builder={builder} value="presence" class="acct-tab-content">
              <.presence_tab away={@away} away_message={@away_message || ""} />
            </.tabs_content>

            <.tabs_content builder={builder} value="modes" class="acct-tab-content">
