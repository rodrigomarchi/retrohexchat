defmodule RetroHexChatWeb.Icons.Alerts do
  ...
  def icon_document_alert(assigns) do
    ...
    <svg class={@class} viewBox="0 0 32 32" aria-hidden="true">
      ...
      <line x1="10" y1="13" x2="22" y2="13" stroke="#000080" stroke-width="1.5" stroke-linecap="round" />
      <line x1="10" y1="17" x2="18" y2="17" stroke="#000080" stroke-width="1.5" stroke-linecap="round" />
  ...
  def icon_question(assigns) do
    ...
    <svg class={@class} viewBox="0 0 32 32" aria-hidden="true">
      ...
      <!-- Question Mark -->
      <path d="M11 11.5 A 5 5 0 1 1 20 12 C 20 15 16 16 16 19" fill="none" stroke="#fff" stroke-width="3" stroke-linecap="round" />
  ...
  def icon_dialog_about(assigns) do
    ...
    <svg class={@class} viewBox="0 0 16 16" shape-rendering="crispEdges" aria-hidden="true">
      ...
      <!-- Octagon base -->
      <polygon points="6,2 11,2 14,5 14,10 11,13 6,13 3,10 3,5" fill="#fff" stroke="#000" stroke-width="1" />
  ...
  def icon_dialog_notifications(assigns) do
    ...
    <svg class={@class} viewBox="0 0 16 16" shape-rendering="crispEdges" aria-hidden="true">
      ...
      <polygon points="5,4 11,4 11,9 13,11 13,12 3,12 3,11 5,9" fill="#FFD700" stroke="#000" stroke-width="1" />
  ...
  def icon_tab_general(assigns) do
    ...
    <svg class={@class} viewBox="0 0 16 16" shape-rendering="crispEdges" aria-hidden="true">
      <!-- Octagon base -->
      <polygon points="5,2 11,2 14,5 14,11 11,14 5,14 2,11 2,5" fill="none" stroke="#000080" stroke-width="1" />
  ...
  def icon_group_notifications(assigns) do
    ...
    <svg class={@class} viewBox="0 0 32 32" aria-hidden="true">
      <!-- Outer shadow -->
      <path d="M16 3 C 10 3 8 8 8 13 v 6 l -4 4 v 2 h 24 v -2 l -4 -4 v -6 C 24 8 22 3 16 3 z" fill="#000" transform="translate(1,1)" />
      <!-- Bell base -->
      <path d="M16 3 C 10 3 8 8 8 13 v 6 l -4 4 v 2 h 24 v -2 l -4 -4 v -6 C 24 8 22 3 16 3 z" fill="#FFD700" stroke="#000" stroke-width="1.5" stroke-linejoin="round" />
      <!-- Top loop -->
      ...
      <text x="26" y="11" text-anchor="middle" font-size="10" font-weight="bold" font-family="sans-serif" fill="#fff">!</text>
    </svg>
    """
  end
  ...
  def icon_group_help(assigns) do
    ...
    <svg class={@class} viewBox="0 0 32 32" aria-hidden="true">
      ...
      <path d="M11 11.5 A 5 5 0 1 1 20 12 C 20 15 16 16 16 19" fill="none" stroke="#000" stroke-width="5" stroke-linecap="round" />
  ...
  def icon_lightbulb(assigns) do
    ...
    <svg class={@class} viewBox="0 0 32 32" aria-hidden="true">
      <!-- Shadow -->
      <path d="M16 2 C 11 2 7 6 7 11 C 7 14 9 17 11 19 V 23 H 21 V 19 C 23 17 25 14 25 11 C 25 6 21 2 16 2 z" fill="#000" transform="translate(1,1)" stroke-linejoin="round" />
      
      <!-- Lightbulb Glass (Yellow/Gold) -->
      <path d="M16 2 C 11 2 7 6 7 11 C 7 14 9 17 11 19 V 23 H 21 V 19 C 23 17 25 14 25 11 C 25 6 21 2 16 2 z" fill="#FFD700" stroke="#000" stroke-width="1.5" stroke-linejoin="round" />
      
      <!-- Yellow glow lines -->
      <path d="M16 4 C 12 4 9 8 9 11" fill="none" stroke="#fff" stroke-width="1.5" opacity="0.6" stroke-linecap="round" />
      
      <!-- Filament -->
      <path d="M13 18 v -4 l 2 -2 l 2 2 v 4" fill="none" stroke="#B8860B" stroke-width="2" stroke-linejoin="round" />
