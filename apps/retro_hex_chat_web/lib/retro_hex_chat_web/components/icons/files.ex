defmodule RetroHexChatWeb.Icons.Files do
  ...
  def icon_folder(assigns) do
    ...
    <svg class={@class} viewBox="0 0 32 32" aria-hidden="true">
      ...
      <!-- Back flap of folder -->
      <path d="M3 9 L 14 9 L 17 12 L 28 12 L 28 25 L 3 25 z" fill="#FFC000" stroke="#000" stroke-width="1.5" stroke-linejoin="round" />
      ...
      <rect x="3" y="13" width="26" height="13" rx="1" fill="#FFD700" stroke="#000" stroke-width="1.5" stroke-linejoin="round" />
      
      <!-- 3D Bevel Highlight (Top/Left) -->
      <path d="M4 25 L 4 14 L 28 14" fill="none" stroke="#fff" stroke-width="1.5" stroke-linecap="round" />
      <path d="M4 11 L 4 10 L 14 10 L 17 13 L 28 13" fill="none" stroke="#fff" stroke-width="1" stroke-linecap="round" />
    </svg>
    """
  end
  ...
  def icon_notepad(assigns) do
    ...
    <svg class={@class} viewBox="0 0 32 32" aria-hidden="true">
      ...
      <!-- Main Paper Body -->
      <path d="M6 3 L 20 3 L 26 9 L 26 27 L 6 27 z" fill="#fff" stroke="#000" stroke-width="1.5" stroke-linejoin="round" />
      
      <!-- Paper Fold Detail (Top Right) -->
      <path d="M20 3 L 20 9 L 26 9" fill="#dfdfdf" stroke="#000" stroke-width="1.5" stroke-linejoin="round" />
  ...
  def icon_trash(assigns) do
    ...
    <svg class={@class} viewBox="0 0 32 32" aria-hidden="true">
      ...
      <!-- Main Bin Body -->
      <path d="M9 8 L 23 8 L 21 28 L 11 28 z" fill="#C0C0C0" stroke="#000" stroke-width="1.5" stroke-linejoin="round" />
  ...
  def icon_backup(assigns) do
    ...
    <svg class={@class} viewBox="0 0 32 32" aria-hidden="true">
      ...
      <!-- Update Arrow (Green) -->
      <path d="M7 23 A 9 9 0 0 0 25 23" fill="none" stroke="#008000" stroke-width="3" stroke-linecap="round" />
      <polygon points="21,20 28,23 23,28" fill="#008000" stroke="#008000" stroke-width="1.5" stroke-linejoin="round" />
    </svg>
    """
  end
  ...
  def icon_file_send(assigns) do
    ...
    <svg class={@class} viewBox="0 0 32 32" aria-hidden="true">
      ...
      <!-- Paper -->
      <path d="M4 4 l 14 0 l 6 6 l 0 18 l -20 0 z" fill="#fff" stroke="#000" stroke-width="1.5" stroke-linejoin="round" />
      <!-- Fold -->
      <path d="M18 4 l 0 6 l 6 0" fill="#dfdfdf" stroke="#000" stroke-width="1.5" stroke-linejoin="round" />
      ...
      <!-- Arrow Send -->
      <path d="M22 17 l 4 3 l -4 3" fill="none" stroke="#000080" stroke-width="2" stroke-linejoin="round" stroke-linecap="round" />
      <path d="M18 13 l 4 3 l -4 3" fill="none" stroke="#000080" stroke-width="2" stroke-linejoin="round" stroke-linecap="round" />
    </svg>
    """
  end
  ...
  def icon_choose_file(assigns) do
    ...
    <svg class={@class} viewBox="0 0 32 32" aria-hidden="true">
      ...
      <!-- Back flap of folder -->
      <path d="M2 9 L 14 9 L 17 12 L 28 12 L 28 25 L 2 25 z" fill="#FFC000" stroke="#000" stroke-width="1.5" stroke-linejoin="round" />
      
      <!-- File inside -->
      <rect x="6" y="5" width="16" height="20" fill="#fff" stroke="#000" stroke-width="1.5" stroke-linejoin="round" />
      ...
      <path d="M2 15 L 28 15 L 30 29 L 4 29 z" fill="#FFD700" stroke="#000" stroke-width="1.5" stroke-linejoin="round" />
  ...
  def icon_copy(assigns) do
    ...
    <svg class={@class} viewBox="0 0 32 32" aria-hidden="true">
      ...
      <!-- Front doc lines -->
      <line x1="15" y1="16" x2="25" y2="16" stroke="#000080" stroke-width="1.5" stroke-linecap="round" />
      <line x1="15" y1="20" x2="25" y2="20" stroke="#000080" stroke-width="1.5" stroke-linecap="round" />
      <line x1="15" y1="24" x2="21" y2="24" stroke="#000080" stroke-width="1.5" stroke-linecap="round" />
    </svg>
    """
  end
end
