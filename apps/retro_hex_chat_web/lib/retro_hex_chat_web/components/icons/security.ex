defmodule RetroHexChatWeb.Icons.Security do
  ...
  def icon_lock(assigns) do
    ...
    <svg class={@class} viewBox="0 0 32 32" aria-hidden="true">
      <!-- Shadow -->
      <path d="M10 14V10C10 6.7 12.7 4 16 4C19.3 4 22 6.7 22 10V14" fill="none" stroke="#000" stroke-width="4" transform="translate(1,1)" />
      <rect x="8" y="14" width="16" height="14" rx="2" fill="#000" transform="translate(1,1)" />
      
      <!-- Lock Shackle Base -->
      <path d="M10 14V10C10 6.7 12.7 4 16 4C19.3 4 22 6.7 22 10V14" fill="none" stroke="#C0C0C0" stroke-width="4" />
      <path d="M10 14V10C10 6.7 12.7 4 16 4C19.3 4 22 6.7 22 10V14" fill="none" stroke="#000" stroke-width="2" />
      
      <!-- Highlight -->
      <path d="M11 12 V 10 C 11 7 13 5 16 5" fill="none" stroke="#fff" stroke-width="1" />
      
      <!-- Lock Body -->
      <rect x="8" y="14" width="16" height="14" rx="2" fill="#FFD700" stroke="#000" stroke-width="1.5" />
  ...
  def icon_shield(assigns) do
    ...
    <svg class={@class} viewBox="0 0 32 32" aria-hidden="true">
      <!-- Shield Shadow -->
      <path d="M16 2 L 4 8 v 8 c 0 7 6 12 12 14 c 6 -2 12 -7 12 -14 V 8 z" fill="#000" transform="translate(1,1)" stroke-linejoin="round" />
      
      <!-- Shield Body -->
      <path d="M16 2 L 4 8 v 8 c 0 7 6 12 12 14 c 6 -2 12 -7 12 -14 V 8 z" fill="#000080" stroke="#000" stroke-width="1.5" stroke-linejoin="round" />
      
      <!-- Inner Shield (White) -->
      <path d="M16 5 L 7 10 v 5 c 0 5 4 9 9 11 c 5 -2 9 -6 9 -11 V 10 z" fill="#fff" stroke="#000080" stroke-width="1.5" stroke-linejoin="round" />
      
      <!-- Checkmark -->
      <path d="M12 15 l 3 4 L 22 12" fill="none" stroke="#008000" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" />
    </svg>
    """
  end
  ...
  def icon_security(assigns) do
    ...
    <svg class={@class} viewBox="0 0 32 32" aria-hidden="true">
      ...
      <path d="M13 13 V 10 C 13 8 15 6 16 6 C 17 6 19 8 19 10 V 13" fill="none" stroke="#C0C0C0" stroke-width="3" />
      <path d="M13 13 V 10 C 13 8 15 6 16 6 C 17 6 19 8 19 10 V 13" fill="none" stroke="#555" stroke-width="1.5" />
  ...
  def icon_rules(assigns) do
    ...
    <svg class={@class} viewBox="0 0 32 32" aria-hidden="true">
      ...
      <path d="M11 8 l 1 1 l 2 -3" fill="none" stroke="#000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
      <!-- Line 1 -->
      ...
      <path d="M11 16 l 1 1 l 2 -3" fill="none" stroke="#000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
      <!-- Line 2 -->
  ...
  def icon_dialog_ignore(assigns) do
    ...
    <svg class={@class} viewBox="0 0 16 16" shape-rendering="crispEdges" aria-hidden="true">
      ...
      <polygon points="11,7 13,7 15,9 15,11 13,13 11,13 9,11 9,9" fill="#808080" stroke="#000" stroke-width="1" />
      <polygon points="10,8 14,8 14,12 12,12 10,12 10,8" fill="none" stroke="#FF0000" stroke-width="1" />
  ...
  def icon_tab_bans(assigns) do
    ...
    <svg class={@class} viewBox="0 0 16 16" shape-rendering="crispEdges" aria-hidden="true">
      <!-- Ban sign (Red Octagon) -->
      <polygon points="5,2 11,2 14,5 14,11 11,14 5,14 2,11 2,5" fill="none" stroke="#FF0000" stroke-width="1" />
