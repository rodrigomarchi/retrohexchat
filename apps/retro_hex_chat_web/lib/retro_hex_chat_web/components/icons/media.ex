defmodule RetroHexChatWeb.Icons.Media do
  ...
  def icon_microphone(assigns) do
    ...
    <svg class={@class} viewBox="0 0 32 32" aria-hidden="true">
      ...
      <!-- Mic Head -->
      <rect x="12" y="3" width="10" height="15" rx="5" fill="#C0C0C0" stroke="#000" stroke-width="1.5" />
      <!-- Head Mesh Lines -->
      ...
      <!-- Armature Shadow -->
      <path d="M7 14 a 9 9 0 0 0 18 0" fill="none" stroke="#000" stroke-width="3" stroke-linecap="round" transform="translate(1,1)" />
      <line x1="16" y1="23" x2="16" y2="28" stroke="#000" stroke-width="3" stroke-linecap="round" transform="translate(1,1)" />
      <line x1="12" y1="28" x2="20" y2="28" stroke="#000" stroke-width="3" stroke-linecap="round" transform="translate(1,1)" />
      
      <!-- Armature -->
      <path d="M7 14 a 9 9 0 0 0 18 0" fill="none" stroke="#000080" stroke-width="3" stroke-linecap="round" />
  ...
  def icon_camera(assigns) do
    ...
    <svg class={@class} viewBox="0 0 32 32" aria-hidden="true">
      ...
      <!-- Lens Shadow -->
      <path d="M22 13 L 28 9 L 28 23 L 22 19 z" fill="#000" stroke-linejoin="round" transform="translate(1,1)" />
      ...
      <!-- Lens -->
      <path d="M22 13 L 28 9 L 28 23 L 22 19 z" fill="#008080" stroke="#000" stroke-width="1.5" stroke-linejoin="round" />
  ...
  def icon_camera_off(assigns) do
    ...
    <svg class={@class} viewBox="0 0 32 32" aria-hidden="true">
      ...
      <!-- Lens (Gray out) -->
      <path d="M22 13 L 28 9 L 28 23 L 22 19 z" fill="#606060" stroke="#000" stroke-width="1.5" stroke-linejoin="round" />
      
      <circle cx="9" cy="12" r="2" fill="#555" stroke="#000" stroke-width="1" />
      
      <!-- Red Slash Shadow -->
      <line x1="3" y1="3" x2="29" y2="29" stroke="#000" stroke-width="4" stroke-linecap="round" transform="translate(1,1)" />
      <!-- Red Slash -->
  ...
  def icon_mute(assigns) do
    ...
    <svg class={@class} viewBox="0 0 32 32" aria-hidden="true">
      <rect x="12" y="3" width="10" height="15" rx="5" fill="#000" transform="translate(1,1)" />
      <rect x="12" y="3" width="10" height="15" rx="5" fill="#808080" stroke="#000" stroke-width="1.5" />
      
      <path d="M7 14 a 9 9 0 0 0 18 0" fill="none" stroke="#000" stroke-width="3" stroke-linecap="round" transform="translate(1,1)" />
      <line x1="16" y1="23" x2="16" y2="28" stroke="#000" stroke-width="3" stroke-linecap="round" transform="translate(1,1)" />
      <line x1="12" y1="28" x2="20" y2="28" stroke="#000" stroke-width="3" stroke-linecap="round" transform="translate(1,1)" />
      
      <path d="M7 14 a 9 9 0 0 0 18 0" fill="none" stroke="#606060" stroke-width="3" stroke-linecap="round" />
      ...
      <!-- Red Slash Shadow -->
      <line x1="5" y1="5" x2="27" y2="27" stroke="#000" stroke-width="4" stroke-linecap="round" transform="translate(1,1)" />
      <!-- Red Slash -->
  ...
  def icon_phone_end(assigns) do
    ...
    <svg class={@class} viewBox="0 0 32 32" aria-hidden="true">
      <!-- Shadow -->
      <path d="M6 18 C 6 8 26 8 26 18 L 19 23 L 15 16 C 15 16 17 16 17 16 L 21 16 C 21 12 11 12 11 16 C 11 16 13 16 13 16 L 17 23 L 6 18 z" fill="#000" transform="translate(1,1)" stroke-linejoin="round" stroke-linecap="round" />
      
      <!-- Base Phone (Red) -->
      <path d="M6 18 C 6 8 26 8 26 18 L 19 23 L 15 16 C 15 16 17 16 17 16 L 21 16 C 21 12 11 12 11 16 C 11 16 13 16 13 16 L 17 23 L 6 18 z" fill="#CC0000" stroke="#000" stroke-width="1.5" stroke-linejoin="round" stroke-linecap="round" />
      
      <!-- Highlights -->
      <path d="M8 17 C 8 10 24 10 24 17" fill="none" stroke="#fff" stroke-width="1.5" opacity="0.6" stroke-linecap="round" />
    </svg>
    """
  end
  ...
  def icon_pip(assigns) do
    ...
    <svg class={@class} viewBox="0 0 32 32" aria-hidden="true">
      ...
      <rect x="2" y="4" width="28" height="22" rx="2" fill="none" stroke="#fff" stroke-width="1.5" stroke-dasharray="29 200" opacity="0.6" />
  ...
  def icon_upgrade_video(assigns) do
    ...
    <svg class={@class} viewBox="0 0 32 32" aria-hidden="true">
      ...
      <!-- Green Up Arrow -->
      <path d="M24 3 L 28 7 L 25 7 L 25 11 L 23 11 L 23 7 L 20 7 z" fill="#00FF00" stroke="#008000" stroke-width="1" stroke-linejoin="round" />
    </svg>
    """
  end
  ...
  def icon_devices(assigns) do
    ...
    <svg class={@class} viewBox="0 0 32 32" aria-hidden="true">
      ...
      <!-- Phone Base -->
      <rect x="6" y="10" width="10" height="18" rx="2" fill="#C0C0C0" stroke="#000" stroke-width="1.5" />
      <rect x="7" y="12" width="8" height="12" fill="#000080" />
      <circle cx="11" cy="26" r="1" fill="#555" />
      <path d="M6 12 L 16 12" stroke="#fff" stroke-width="1" />
      
      <!-- Signal Waves -->
      <path d="M19 12 C 21 14 21 18 19 20" fill="none" stroke="#000080" stroke-width="2" stroke-linecap="round" />
      <path d="M22 8 C 26 12 26 20 22 24" fill="none" stroke="#000080" stroke-width="2" stroke-linecap="round" />
    </svg>
    """
  end
