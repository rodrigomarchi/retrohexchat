defmodule RetroHexChatWeb.Icons.Hardware do
  ...
  def icon_laptop(assigns) do
    ...
    <svg class={@class} viewBox="0 0 32 32" aria-hidden="true">
      <!-- Laptop Shadow -->
      <path d="M6 4 h 20 v 14 h 4 l -2 4 h -24 l -2 -4 h 4 z" fill="#000" transform="translate(1,1)" stroke-linejoin="round" />
      ...
      <path d="M8 7 L 24 7 M 8 16" stroke="#fff" stroke-width="1.5" opacity="0.6" stroke-linecap="round" />
      <polygon points="18,6 24,6 24,14 18,14" fill="#fff" opacity="0.1" />
      
      <!-- Base Deck -->
      <path d="M6 18 h 20 l 2 4 h -24 z" fill="#C0C0C0" stroke="#000" stroke-width="1.5" stroke-linejoin="round" />
      <!-- Base Deck Bevel -->
  ...
  def icon_server(assigns) do
    ...
    <svg class={@class} viewBox="0 0 32 32" aria-hidden="true">
      ...
      <!-- Rack 2 -->
      <rect x="4" y="18" width="24" height="10" rx="2" fill="#000080" stroke="#000" stroke-width="1.5" />
  ...
  def icon_elixir(assigns) do
    ...
    <svg class={@class} viewBox="0 0 32 32" aria-hidden="true">
      <!-- Shadow -->
      <path d="M16 2 C12 8 8 14 8 20 C8 26 12 30 16 30 C20 30 24 26 24 20 C24 14 20 8 16 2 Z" fill="#000" transform="translate(1,1)" stroke-linejoin="round" />
      
      <!-- Base Drop (Purple/Navy) -->
      <path d="M16 2 C12 8 8 14 8 20 C8 26 12 30 16 30 C20 30 24 26 24 20 C24 14 20 8 16 2 Z" fill="#4B0082" stroke="#000" stroke-width="1.5" stroke-linejoin="round" />
      
      <!-- Inner Glow (Teal) -->
      <path d="M16 6 C13 11 11 15 11 20 C11 24 13 27 16 27 C19 27 21 24 21 20 C21 15 19 11 16 6 Z" fill="#008080" />
      
      <!-- Left Highlight -->
      <path d="M15 4 C11 10 9.5 15 9.5 20 C9.5 24 11 27 14 28" fill="none" stroke="#fff" stroke-width="2" opacity="0.6" stroke-linecap="round" />
    </svg>
    """
  end
  ...
  def icon_dialog_channel_list(assigns) do
    ~H"""
    <svg class={@class} viewBox="0 0 16 16" shape-rendering="crispEdges" aria-hidden="true">
      <text x="2" y="11" font-size="10" font-weight="bold" font-family="sans-serif" fill="#FFD700">#</text>
      <!-- List lines (White) -->
