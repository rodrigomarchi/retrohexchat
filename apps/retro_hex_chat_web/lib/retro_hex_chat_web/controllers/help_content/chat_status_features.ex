defmodule RetroHexChatWeb.HelpContent.ChatStatusFeatures do
  ...
  embed_templates "feature_{identity_presence*,nick_alignment*,nick_expiry*,notices*,notify_list*,paste_dialog*,perform*,pm_persistence*,quit_message*,search*,smart_input*,sounds*,special_messages*,status_bar*,timers*,timestamp_format*,typing_indicator*,unread_indicators*,url_catcher*}"
end
