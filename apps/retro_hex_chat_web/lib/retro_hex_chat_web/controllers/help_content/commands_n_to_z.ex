defmodule RetroHexChatWeb.HelpContent.CommandsNtoZ do
  ...
  embed_templates "cmd_{nick*,notice*,notify*,ns*,op*,p2p*,part*,perform*,popups*,query*,quit*,setmotd*,setwelcome*,singleplayer*,slow*,space*,timer*,topic*,transfer*,umode*,unban*,unignore*,unmute*,voice*,wallops*,whois*,whowas*}"
end
