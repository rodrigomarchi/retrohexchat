    ...
    [
      ...
      %{
        ...
        description:
          dgettext(
            "help",
            "Monitor RSS/Atom feeds and post new items as rich Markdown cards, combining page metadata with feed summaries, authors, dates, media hints and cached thumbnails."
          ),
