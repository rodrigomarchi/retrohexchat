        ...
        description:
          dgettext(
            ...
            "Invite someone to a P2P session that runs an audio/video call, file transfers, " <>
              "and games together over one connection. The request arrives in the private " <>
              "message as a card carrying the session's own address; both of you enter " <>
              "through that card, which opens the session in a tab of its own. Decline " <>
              "sits beside it for the person who would rather not. " <>
