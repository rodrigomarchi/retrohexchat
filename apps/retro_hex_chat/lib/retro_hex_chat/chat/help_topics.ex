defmodule RetroHexChat.Chat.HelpTopics do
  ...
  @category_icons %{
    ...
    dgettext_noop("help", "Virtual Spaces") => :icon_community,
    dgettext_noop("help", "Retro Games") => :icon_game_pong,
  ...
  @categories [
    ...
    dgettext_noop("help", "Virtual Spaces"),
    dgettext_noop("help", "Retro Games"),
