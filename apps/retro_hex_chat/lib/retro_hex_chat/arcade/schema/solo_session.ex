defmodule RetroHexChat.Arcade.Schema.SoloSession do
  @moduledoc """
  Ecto schema for solo_sessions table.
  Represents a single-player arcade session for one registered user.
  """
  use Ecto.Schema
