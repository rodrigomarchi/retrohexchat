defmodule RetroHexChat.Games.Supervisor do
  @moduledoc """
  DynamicSupervisor for game session GenServer processes.
  One child process per active game session (Constitution III).
  """
  ...
  def start_child(supervisor \\ __MODULE__, token) do
    DynamicSupervisor.start_child(supervisor, {RetroHexChat.Games.SessionServer, token})
  end
