defmodule RetroHexChat.Commands.Registry do
  ...
  @commands %{
    ...
    "mute" => RetroHexChat.Commands.Handlers.MuteCmd,
    ...
    "lobby" => RetroHexChat.Commands.Handlers.Lobby,
    ...
    "transfer" => RetroHexChat.Commands.Handlers.Transfer,
    ...
    "unmute" => RetroHexChat.Commands.Handlers.Unmute,
    "voice" => RetroHexChat.Commands.Handlers.VoiceCmd,
