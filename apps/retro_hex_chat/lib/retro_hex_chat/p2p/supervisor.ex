defmodule RetroHexChat.P2P.Supervisor do
  @moduledoc """
  DynamicSupervisor for P2P session GenServer processes.
  ...
  def start_child(supervisor \\ __MODULE__, token) do
    DynamicSupervisor.start_child(supervisor, {RetroHexChat.P2P.SessionServer, token})
  end
