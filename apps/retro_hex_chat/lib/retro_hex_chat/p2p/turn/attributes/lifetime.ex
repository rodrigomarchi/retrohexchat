defmodule RetroHexChat.P2P.Turn.Attributes.Lifetime do
  @moduledoc false
  ...
  @spec decode(binary()) :: {:ok, t()} | {:error, :invalid_lifetime}
  defp decode(<<lifetime::32>>), do: {:ok, %__MODULE__{lifetime: lifetime}}
